...
type GuestFirstScanPanelProps = {
  /** When true, section title renders as `h2` for use under an existing page `h1`. */
  embedded?: boolean
}

export function GuestFirstScanPanel({ embedded = false }: GuestFirstScanPanelProps) {
